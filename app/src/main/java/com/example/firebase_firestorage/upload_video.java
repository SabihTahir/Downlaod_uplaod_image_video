...
public class upload_video extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            videoView = findViewById(R.id.UploadVV);
        ...
        try {
            ...
            if(isvideoselected && !videonameET.getText().toString().isEmpty())
            {
                ...
                uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                        ...
                        if(task.isSuccessful())
                        {
                            ...
                            db.collection("VideoLinks").document(videonameET.getText().toString()).set(datamap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(upload_video.this, "Video Uploaded Succesfully", Toast.LENGTH_SHORT).show();
                                }
                            }).addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(upload_video.this, "Video Not uploaded Successfully", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                        else
                    ...
                    public void onFailure(@NonNull Exception e) {
                        dialog.dismiss();
                        Toast.makeText(upload_video.this, "Video Not Uploaded Successfully"+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
